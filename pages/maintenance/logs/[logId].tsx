...
import { useLogDetails } from '../../../components/maintenance/logs/details/useLogDetails';
import { RootState } from '../../../components/store/store';
import { useRouter } from 'next/router';
import { GlobalDebug } from '../../../components/utility/debug/globalDebug';
...
const LogDetails = () => {
    ...
    const logId = parseInt(router.asPath.split('/')[3]);
